...
router.patch("/update_one/:productId", (0, authMiddleware_1.default)([authMiddleware_1.Roles.Admin]), (0, multer_1.fileUploud)(multer_1.fileType.imageTypes).single("image"), (0, errorHandling_1.asyncHandler)(productAdminController_1.productAdminController.updateOne));
router.delete("/delete_one/:productId", (0, authMiddleware_1.default)([authMiddleware_1.Roles.Admin]), (0, errorHandling_1.asyncHandler)(productAdminController_1.productAdminController.deleteOne));
