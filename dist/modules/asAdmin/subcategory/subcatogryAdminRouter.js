...
router.get("/read_all", (0, errorHandling_1.asyncHandler)(subcatogryAdminController_1.subcategoryAdminController.readSubcategoryForOneCategory));
router.post("/", (0, authMiddleware_1.default)(authMiddleware_1.Roles.Admin), (0, multer_1.fileUploud)(multer_1.fileType.imageTypes).single("image"), (0, errorHandling_1.asyncHandler)(subcatogryAdminController_1.subcategoryAdminController.create));
